...
while read -r URL; do
	...
	<td><a href=\"../dumps-text/$basename-$lineno.txt\">chin-$lineno</a></td>
	<td><a href=\"../aspirations/$basename-$lineno.html\">chin-$lineno</a></td>
	<td>$occurences</td>
	<td><a href=\"../contextes/$basename-$lineno.txt\">chin-$lineno</a></td>
	<td><a href=\"./../concordances/$basename-$lineno.html\">chin-$lineno</a></td>
	</tr>" >> $fichier_tableau
