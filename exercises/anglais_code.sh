...
# Ce script bash prend en arguement un fichier .txt 
...
while read -r URL; do
	...
	<td><a href=\"../dumps-text/$basename-$lineno.txt\">ang-$lineno</a></td>
	<td><a href=\"../aspirations/$basename-$lineno.html\">ang-$lineno</a></td>
	<td>$occurences</td>
	<td><a href=\"../contextes/$basename-$lineno.txt\">ang-$lineno</a></td>
	<td><a href=\"./../concordances/$basename-$lineno.html\">ang-$lineno</a></td>
	</tr>" >> $fichier_tableau
