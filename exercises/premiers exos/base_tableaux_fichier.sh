...
#dump = code privé du html, 
# lynx?  >> dumpfile # something with basename
### 
# basename sert à faire le ménage du nom 
## creating dump-text in variable $dump 
#echo "$dump" > "dumps-text/$basename-$lineno.txt"
## similar steps to be done for html, etc. 

### 
#for absolute path /Documents/PLURITAL-Sem1/Projet-encadre-Wed-8h30/PPE1/exercises/url_fastfood.txt
